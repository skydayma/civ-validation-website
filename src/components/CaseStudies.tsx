...
const CaseStudies = () => {
  return (
    <section id="case-studies" className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-white relative">
      {/* Background elements */}
      ...
      <div className="section-container relative z-10">
        <div className="text-center mb-10 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-4 gradient-text">Trusted by Industry Leaders</h2>
        ...
        {/* Logo showcase */}
        <Card className="mb-12 shadow-lg border-none bg-white/80 backdrop-blur-sm animate-on-scroll rounded-2xl">
              ...
              >
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-700 mb-4 text-lg italic">&ldquo;{testimonial.quote}&rdquo;</p>
