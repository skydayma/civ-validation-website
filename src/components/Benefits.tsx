...
const benefits = [
  {
    ...
    icon: (
      <div className="h-16 w-16 rounded-full bg-civ-lightgreen flex items-center justify-center text-civ-blue">
      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            <div 
              key={benefit.id} 
              className="animate-on-scroll bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center"
              style={{animationDelay: `${index * 100}ms`}}
            >
              {benefit.icon}
              <div className="mt-4 mb-2 text-4xl font-bold text-civ-blue">{benefit.percentage}</div>
