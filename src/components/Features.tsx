...
const Features = () => {
  return (
    <section id="features" className="py-12 md:py-16 bg-gradient-to-tr from-white to-blue-50 relative overflow-hidden">
      ...
      <div className="section-container">
        <div className="text-center mb-10 animate-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-4 gradient-text">Overview of cIV</h2>
              ...
              <Card className="feature-card h-full border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden rounded-2xl">
                <CardContent className="p-0">
                  <div className="flex flex-col md:flex-row">
                    <div className="md:w-1/3 bg-gradient-to-br from-civ-blue to-civ-darkblue p-5 flex items-center justify-center">
                      <div className="h-14 w-14 rounded-full bg-white/10 flex items-center justify-center shadow-lg">
                        {feature.icon}
                      </div>
                    </div>
